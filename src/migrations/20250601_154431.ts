...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_header_nav_items_nav_items_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TABLE IF NOT EXISTS "header_nav_items_nav_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_header_nav_items_nav_items_link_type" DEFAULT 'reference',
  ...
  DO $$ BEGIN
   ALTER TABLE "header_nav_items_nav_items" ADD CONSTRAINT "header_nav_items_nav_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."header_nav_items"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "header_nav_items_nav_items_order_idx" ON "header_nav_items_nav_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "header_nav_items_nav_items_parent_id_idx" ON "header_nav_items_nav_items" USING btree ("_parent_id");
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "header_nav_items_nav_items" CASCADE;
  ...
  DROP TYPE "public"."enum_header_nav_items_nav_items_link_type";`)
}
